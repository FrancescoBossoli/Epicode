...
function compra() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, array, i, vestito;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://localhost:3000/Abbigliamento')];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    for (i = 0; i < array.length; i++) {
                        console.log(array[i]);
                        vestito = new Abbigliamento(array[i].id, array[i].codprod, array[i].collezione, array[i].capo, array[i].modello, array[i].quantita, array[i].colore, array[i].prezzoivaesclusa, array[i].prezzoivainclusa, array[i].disponibile, array[i].saldo);
