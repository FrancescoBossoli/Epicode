...
btnAdd.addEventListener("click", function (e) {
    return __awaiter(this, void 0, void 0, function () {
        var newTitle, newCategory, newContent, newTask;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                    newTitle = document.getElementById("titolo").value;
                    newCategory = document.getElementById("categoria").value;
                    newContent = document.getElementById("contenuto").value;
                    if (!(newTitle && newCategory && newContent)) return [3 /*break*/, 2];
                    newTask = new Task(newTitle, newCategory, newContent);
                    return [4 /*yield*/, addToList(newTask)];
                case 1:
                    _a.sent();
                    print();
                    return [3 /*break*/, 3];
...
function print() {
    var _this = this;
    fetch("http://localhost:3000/tasks").then(function (response) { return response.json(); }).then(function (data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            arrayTask = data;
...
function deleteTask(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://localhost:3000/tasks/' + id, {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json;charset=utf-8'
                        },
